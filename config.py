...
BOT_USERNAME = getenv("BOT_USERNAME", "ANIME_MUSIC_ROBOT")
# Don't Add style font 
BOT_NAME = getenv("BOT_NAME", "˹ᴀɴɪᴍᴇ ✘ ᴍᴜꜱɪᴄ˼")
#get Your Assistant User name
ASSUSERNAME = getenv("ASSUSERNAME", "musicsXanime")
EVALOP = list(map(int, getenv("EVALOP", "7082528938").split()))
...
LOGGER_ID = int(getenv("LOGGER_ID", "-1002118567120"))

# Get this value from  on Telegram by /id
OWNER_ID = int(getenv("OWNER_ID", "7082528938"))
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/telegrambot622/AMRITMUSIC",
)
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/ANIME_X_SUPPORT")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/ANIME_X_SUPPORTS")
